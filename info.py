...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = f"""
╔══════════════════════════════════════════════╗
║ 🔥 WELCOME TO — VILAX LORD INFORMATION BOT 🔥 ║
╠══════════════════════════════════════════════╣
║ 🤴 THIS BOT MADE BY VILAXLORD                ║
║ 💻 Developer ➜ @VILAXLORD                    ║
...
def main():
    """Start the bot"""
    print(f"{Fore.GREEN}🚀 Starting VILAX LORD Information Bot...{Style.RESET_ALL}")
    ...
    print(f"{Fore.RED}⏹️ Press Ctrl+C to stop{Style.RESET_ALL}")
